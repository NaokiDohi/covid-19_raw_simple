# -*- coding: utf-8 -*-
"""covid-19_forecast_with_gru.ipynb
...
print("gru_n:"+str(n_hidden)+"_dropout:"+str(drop_out))
print("")
...
path = "gru/model/gru_"+str(n_hidden)+"_"+str(drop_out)+".h5"
model.save(path)
...
path = "gru/loss/loss_"+str(n_hidden)+"_"+str(drop_out)+".png"
...
path = "gru/eval_loss/eval_loss_"+str(n_hidden)+"_"+str(drop_out)+".png"
