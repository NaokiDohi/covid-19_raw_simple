# -*- coding: utf-8 -*-
"""covid-19_forecast_with_rnn.ipynb
...
path = "rnn/model/rnn_"+str(n_hidden)+"_"+str(drop_out)+".h5"
model.save(path)
...
path = "rnn/loss/loss_"+str(n_hidden)+"_"+str(drop_out)+".png"
...
path = "rnn/eval_loss/eval_loss_"+str(n_hidden)+"_"+str(drop_out)+".png"
...
# sns.set()
path = "rnn/prediction/prediction_"+str(n_hidden)+"_"+str(drop_out)+".png"
